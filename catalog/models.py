...
class Language(models.Model):
    name = models.CharField(
        max_length=200,
        help_text='Введите оригинальный язык книги'
    )
...
class Book(models.Model):
    ...
    genre = models.ManyToManyField(Genre, help_text='Выберите жанр произведения')
...
class BookInstance(models.Model):
    id = models.UUIDField(
        primary_key=True,
        default=uuid.uuid4,
        help_text='Уникальный ID для конкретной книги в библиотеке'
    )
